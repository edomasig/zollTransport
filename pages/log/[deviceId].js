  ...
  return (
    <div className="min-h-screen bg-neutral-light text-gray-800 font-sans p-4">
      <div className="container mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold text-primary-dark mb-6 text-center">
          Log for Device: {deviceId}
        </h1>
        {deviceId && (
          <p className="text-base text-gray-600 mb-6 text-center">
            Note: Ensure this device ID has been registered in the Admin
            Dashboard before submitting a log.
          </p>
        )}
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              className="mt-1 block w-full rounded-md border-neutral-dark shadow-sm focus:border-primary focus:ring focus:ring-primary-light focus:ring-opacity-50 p-3 text-lg"></textarea>
          </div>
          <div>
            <label
              htmlFor="nurseName"
